  ...
  return (
    <main className="bg-white h-fit w-full flex flex-col text-black">
      ...
      <div className=" h-60 flex-col lg:mb-10 mb-80 ">
        <div className="h-fit pl-[154px] pr-[108px] text-black text-5xl font-normal capitalize mb-4 ">
        ...
        <div className="text-black text-5xl  font-normal uppercase relative text-right pr-16">
